...
document.addEventListener("deviceready", function(){
	...
	if(navigator.connection.type == states[Connection.NONE] ){
	...
	try
{
  ...
  //Options: throw an error if no update is received every 30 seconds.
    //
    watch_id = navigator.geolocation.watchPosition(onSuccesswatchPosition, onErrorwatchPosition, { frequency: 1000, enableHighAccuracy: true, timeout: 120000 , maximumAge: 0});
...
//        { frequency: 1000, enableHighAccuracy: true });
	...
	{
		alert('startTracking_stop error' + e)
	}
});
...
$("#startTracking_stop").live('click', function(){
	...
	//alert(JSON.stringify(tracking_data_copy));
